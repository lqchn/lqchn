"""
Django settings for lqchn project.
...
SECRET_KEY = 'q55pfp(bb(s_tn=ys+1emi0wt%+zvu_$aot-@ffipkm+#zp&x!'
...
ROOT_URLCONF = 'lqchn.urls'

WSGI_APPLICATION = 'lqchn.wsgi.application'
